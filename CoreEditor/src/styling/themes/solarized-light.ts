...
const colors: EditorColors = {
  ...
  lineNumber: '#9ca8a6',
  searchMatch: '#f4c09d',
  selectionHighlight: '#f4c09d99',
  visibleSpace: '#586e7580',
  lighterBackground: '#586e7526',
...
function highlight() {
  ...
  return buildHighlight(colors, [
    ...
    { tag: [tags.list, tags.bool, tags.className, tags.definition(tags.typeName), tags.definition(tags.propertyName)], color: '#b58900' },
    ...
    { tag: [tags.contentSeparator, tags.url, tags.propertyName, tags.linkMark, tags.listMark], color: colors.text },
