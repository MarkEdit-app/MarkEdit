...
const glows = {
  yellow: shadowableTextColor(`color: ${colors.yellow}; text-shadow: 0 0 2px #393a33, 0 0 8px #f39f0575, 0 0 2px #f39f0575`),
  green: shadowableTextColor(`color: ${colors.green}; text-shadow: 0 0 2px #100c0f, 0 0 10px #257c5575, 0 0 35px #21272475`),
...
function highlight() {
  ...
  return buildHighlight(colors, [
    ...
    { tag: [tags.meta, tags.comment, tags.contentSeparator], color: colors.comment, fontStyle: 'italic' },
    ...
    { tag: tags.strong, color: colors.blue, fontWeight: 'bold' },
    { tag: tags.emphasis, color: colors.blue, fontStyle: 'italic' },
    ...
    { tag: [tags.labelName, tags.null, tags.number, tags.bool], color: colors.orange },
  ], 'dark');
}
