...
const colors: EditorColors = {
  ...
  selection: '#40537d',
  activeLine: '#0c499444',
  matchingBracket: '#219fd54d',
  lineNumber: '#219fd5',
  searchMatch: '#103362',
  selectionHighlight: '#103362',
  visibleSpace: '#3b3a32',
...
function highlight() {
  ...
  return buildHighlight(colors, [
    ...
    { tag: [tags.operator, tags.operatorKeyword], color: '#00bff9' },
    { tag: [tags.escape, tags.string, tags.link, tags.regexp, tags.special(tags.string)], color: '#bcf0c0' },
