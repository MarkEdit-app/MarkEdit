...
function highlight() {
  ...
  return buildHighlight(colors, [
    ...
    { tag: [tags.link, tags.escape, tags.string, tags.inserted, tags.regexp, tags.special(tags.string)], color: '#a5ff90' },
    { tag: tags.listMark, color: palette.accent },
