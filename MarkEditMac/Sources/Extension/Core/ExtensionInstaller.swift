...
extension Localized {
  enum Extension {
    ...
    static let viewRelease = String(localized: "View Release Page", comment: "Button in the release notes popover to open the release page")
    ...
    static let updateBehavior = String(localized: "Update Behavior", comment: "Submenu title for how the app handles extension updates, from never checking to fully automatic")
    static let behaviorNever = String(localized: "Never Check", comment: "Update behavior: never reach the registry in the background")
    static let behaviorQuiet = String(localized: "Show Available Updates", comment: "Update behavior: only surface updates in the Extensions window")
    static let behaviorNotify = String(localized: "Ask Before Updating", comment: "Update behavior: prompt before updating")
    static let behaviorAutomatic = String(localized: "Update Automatically", comment: "Update behavior: update automatically")
