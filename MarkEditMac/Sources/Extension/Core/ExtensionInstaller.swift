...
extension Localized {
  enum Extension {
    ...
    static let updateCheckFrequency = String(localized: "Update Check Frequency", comment: "Submenu title for how often to check for extension updates")
    static let checkNever = String(localized: "Never", comment: "Update check cadence: never")
    static let checkOnLaunch = String(localized: "On Launch", comment: "Update check cadence: on every launch")
    static let checkDaily = String(localized: "Daily", comment: "Update check cadence: daily")
    static let checkWeekly = String(localized: "Weekly", comment: "Update check cadence: weekly")
    static let updateInstallBehavior = String(localized: "Update Install Behavior", comment: "Submenu title for what to do once an extension update is found")
    static let strategyManual = String(localized: "Manually", comment: "Update strategy: only surface updates in the Extensions window")
    static let strategyPrompt = String(localized: "Ask Before Updating", comment: "Update strategy: prompt before updating")
    static let strategyAutomatic = String(localized: "Update Automatically", comment: "Update strategy: update automatically")
