...
///
/// Mirrors `AppRuntimeConfig`, the remote catalog is fetched by `AppExtensionRegistry`.
enum AppExtensionConfig {
...
private extension AppExtensionConfig {
  enum Constants {
