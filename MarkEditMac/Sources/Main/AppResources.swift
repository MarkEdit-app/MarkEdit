...
enum Localized {
  enum General {
    static let okay = String(localized: "OK", comment: "General \"OK\" title in alerts")
    static let cancel = String(localized: "Cancel", comment: "General \"Cancel\" title in alerts")
